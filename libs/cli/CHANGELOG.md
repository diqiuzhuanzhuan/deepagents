...
## [0.1.0](https://github.com/diqiuzhuanzhuan/deepagents/compare/deepagents-cli==0.2.2...deepagents-cli==0.1.0) (2026-06-10)
...
* **cli:** `/copy` slash command ([#3225](https://github.com/diqiuzhuanzhuan/deepagents/issues/3225)) ([646df53](https://github.com/diqiuzhuanzhuan/deepagents/commit/646df5364274ba11c1104038095ed4478c076c40))
* **cli:** `/reload` skill diff report ([#3153](https://github.com/diqiuzhuanzhuan/deepagents/issues/3153)) ([7c3278a](https://github.com/diqiuzhuanzhuan/deepagents/commit/7c3278a46fe1bace82224f43d8e1b7a023d0086a))
* **cli:** add `--host` option to `deepagents dev` command ([#3444](https://github.com/diqiuzhuanzhuan/deepagents/issues/3444)) ([0bb1e74](https://github.com/diqiuzhuanzhuan/deepagents/commit/0bb1e74bba8097b38f204e3db6e6ebad7e0f5317))
* **cli:** add `ContextHubBackend` for iteration in `deepagents-deploy` ([#2923](https://github.com/diqiuzhuanzhuan/deepagents/issues/2923)) ([fb0f0ba](https://github.com/diqiuzhuanzhuan/deepagents/commit/fb0f0ba08a58c3d2ae5db2435c07e3b826f395fa))
* **cli:** add docs link to project MCP approval prompt ([#3341](https://github.com/diqiuzhuanzhuan/deepagents/issues/3341)) ([b5c1228](https://github.com/diqiuzhuanzhuan/deepagents/commit/b5c12280e47bc37938290a4219317f47c1abfa8a))
* **cli:** add env var for launch theme ([#3176](https://github.com/diqiuzhuanzhuan/deepagents/issues/3176)) ([47a3e4e](https://github.com/diqiuzhuanzhuan/deepagents/commit/47a3e4e219bf43a08697fceabfaddcadc464c97b))
* **cli:** add splash tips visibility env var ([#3179](https://github.com/diqiuzhuanzhuan/deepagents/issues/3179)) ([c9be71c](https://github.com/diqiuzhuanzhuan/deepagents/commit/c9be71ce431aadbf24424411a57fada2ed560c93))
* **cli:** add splash version visibility env var ([#3173](https://github.com/diqiuzhuanzhuan/deepagents/issues/3173)) ([f57d09e](https://github.com/diqiuzhuanzhuan/deepagents/commit/f57d09e46b965091525817d1e17741ec61aa6274))
* **cli:** add startup splash env var overrides ([#3175](https://github.com/diqiuzhuanzhuan/deepagents/issues/3175)) ([8d3d197](https://github.com/diqiuzhuanzhuan/deepagents/commit/8d3d197941c878a409795b870c308f4b761dea5b))
* **cli:** add terminal OSC 9;4 progress & escape helper ([#3347](https://github.com/diqiuzhuanzhuan/deepagents/issues/3347)) ([75d60cd](https://github.com/diqiuzhuanzhuan/deepagents/commit/75d60cd82f559b2944b78a348d16b0a10a00d663))
* **cli:** add TUI footer visibility env vars ([#3171](https://github.com/diqiuzhuanzhuan/deepagents/issues/3171)) ([8f5796b](https://github.com/diqiuzhuanzhuan/deepagents/commit/8f5796b3704c95c6f775445496177d955eec2da3))
* **cli:** auto-wire issues board with context hub repo handle ([#3231](https://github.com/diqiuzhuanzhuan/deepagents/issues/3231)) ([94628fe](https://github.com/diqiuzhuanzhuan/deepagents/commit/94628fef98aefb5389ab56c8acee31726d6385dc))
* **cli:** emit `user.name.set` hook during onboarding ([#3177](https://github.com/diqiuzhuanzhuan/deepagents/issues/3177)) ([43a494e](https://github.com/diqiuzhuanzhuan/deepagents/commit/43a494ed2fe44b7ba3a03d9833301ff3fc485b73))
* **cli:** external event listener via Unix domain socket ([#3207](https://github.com/diqiuzhuanzhuan/deepagents/issues/3207)) ([ffeac22](https://github.com/diqiuzhuanzhuan/deepagents/commit/ffeac22f8e5572681ca1ad7c4f2e55ef57207577))
* **cli:** filter threads in switcher by directory ([#3290](https://github.com/diqiuzhuanzhuan/deepagents/issues/3290)) ([07a973a](https://github.com/diqiuzhuanzhuan/deepagents/commit/07a973ae5b0256fddfd9591dc88c7987e5581264))
* **cli:** first-run onboarding flow ([#3102](https://github.com/diqiuzhuanzhuan/deepagents/issues/3102)) ([a71f852](https://github.com/diqiuzhuanzhuan/deepagents/commit/a71f852df3e491326b8eaa03ee7cb7b3b94fe73d))
* **cli:** free-text reject reason on HITL approval prompt ([#3344](https://github.com/diqiuzhuanzhuan/deepagents/issues/3344)) ([dcc48f4](https://github.com/diqiuzhuanzhuan/deepagents/commit/dcc48f48d20757f17011e65b61363dd0347af164))
* **cli:** in-TUI API key entry via `/auth` ([#3123](https://github.com/diqiuzhuanzhuan/deepagents/issues/3123)) ([eedbc3a](https://github.com/diqiuzhuanzhuan/deepagents/commit/eedbc3a8b5f88059636e497f72c7cec5a420f998))
* **cli:** incognito shell command mode ([#3252](https://github.com/diqiuzhuanzhuan/deepagents/issues/3252)) ([56aee50](https://github.com/diqiuzhuanzhuan/deepagents/commit/56aee504b5f8196d569757794e2e7e61cf9bef18))
* **cli:** live progress UI and periodic recheck for self-updates ([#3280](https://github.com/diqiuzhuanzhuan/deepagents/issues/3280)) ([3e9e805](https://github.com/diqiuzhuanzhuan/deepagents/commit/3e9e80597d9e2edc7685400023a2cad15a84a6b8))
* **cli:** migrate deepagents deploy to use managed deep agents api [AB-2470] ([#3609](https://github.com/diqiuzhuanzhuan/deepagents/issues/3609)) ([72aef52](https://github.com/diqiuzhuanzhuan/deepagents/commit/72aef52542a3fd4a7eebcb3dba40e28adf1aa044))
* **cli:** Ollama model discovery via probe ([#3286](https://github.com/diqiuzhuanzhuan/deepagents/issues/3286)) ([c1dd6c8](https://github.com/diqiuzhuanzhuan/deepagents/commit/c1dd6c8a0f8b423edc75be243fc0487e4c900703))
* **cli:** per-terminal theme selection ([#3248](https://github.com/diqiuzhuanzhuan/deepagents/issues/3248)) ([e2251f1](https://github.com/diqiuzhuanzhuan/deepagents/commit/e2251f17c0cc9363d6ed2385436ade22a8e74cd2))
* **cli:** remove coding agent ([#3422](https://github.com/diqiuzhuanzhuan/deepagents/issues/3422)) ([c7b3119](https://github.com/diqiuzhuanzhuan/deepagents/commit/c7b311933da6245267f4bded050c36279973de1e))
* **cli:** richer provider auth states, hosted Ollama auth ([#3111](https://github.com/diqiuzhuanzhuan/deepagents/issues/3111)) ([eeaeb76](https://github.com/diqiuzhuanzhuan/deepagents/commit/eeaeb7663515eb0cfa8f0389e7f8446e95e84911))
* **cli:** set-as-default in `/agents` picker, harden persistence ([#3126](https://github.com/diqiuzhuanzhuan/deepagents/issues/3126)) ([4751e33](https://github.com/diqiuzhuanzhuan/deepagents/commit/4751e33fbad5945a740cae03bda758223201433b))
* **cli:** show sandbox provider in header `sub_title` ([#3295](https://github.com/diqiuzhuanzhuan/deepagents/issues/3295)) ([779f7f4](https://github.com/diqiuzhuanzhuan/deepagents/commit/779f7f45c501f3c6d53e12087e3d4c340ef8aded))
* **cli:** strip provider-specific model prefixes in status bar footer ([#3222](https://github.com/diqiuzhuanzhuan/deepagents/issues/3222)) ([eaa1d82](https://github.com/diqiuzhuanzhuan/deepagents/commit/eaa1d821c96246471b274663e714878fdd2f67bb))
* **cli:** surface MCP config discovery paths and format in help screens ([#3152](https://github.com/diqiuzhuanzhuan/deepagents/issues/3152)) ([ce6887c](https://github.com/diqiuzhuanzhuan/deepagents/commit/ce6887c89bacee63bdd74ab9d26097e2e418ff43))
* **cli:** surface sandbox startup errors in server crash messages ([#3306](https://github.com/diqiuzhuanzhuan/deepagents/issues/3306)) ([2606d57](https://github.com/diqiuzhuanzhuan/deepagents/commit/2606d57b623f16955df6f91e693051f4b61f6120))
...
* **evals:** add `open-fireworks` model preset ([#3182](https://github.com/diqiuzhuanzhuan/deepagents/issues/3182)) ([a748fdd](https://github.com/diqiuzhuanzhuan/deepagents/commit/a748fddd1ef463212e28dd0f6d0be6403ed8dd9f))
...
* **ci,deps:** harden manual releases and update `python-multipart` ([#3383](https://github.com/diqiuzhuanzhuan/deepagents/issues/3383)) ([a5da793](https://github.com/diqiuzhuanzhuan/deepagents/commit/a5da793a78fcd8e9dc47a6cc1f5d62b9eb049543))
* **cli:** add `together` provider to bundler deps and optional extras ([#2670](https://github.com/diqiuzhuanzhuan/deepagents/issues/2670)) ([4290953](https://github.com/diqiuzhuanzhuan/deepagents/commit/4290953e44570ec02399e4d423ab4ffd24e97609))
* **cli:** allow multiple-choice labels to wrap in narrow ask-user menus ([#3257](https://github.com/diqiuzhuanzhuan/deepagents/issues/3257)) ([79a38d9](https://github.com/diqiuzhuanzhuan/deepagents/commit/79a38d9a3a18f28903717a0d4efa8ad66caee129))
* **cli:** allow TUI launch without preconfigured model credentials ([#3301](https://github.com/diqiuzhuanzhuan/deepagents/issues/3301)) ([aa28ff7](https://github.com/diqiuzhuanzhuan/deepagents/commit/aa28ff73768a826b216bfa54d76ecd313c325077))
* **cli:** apply `--model-params` on `/model` re-select ([#3072](https://github.com/diqiuzhuanzhuan/deepagents/issues/3072)) ([50546dd](https://github.com/diqiuzhuanzhuan/deepagents/commit/50546dd3d368af297084929ee3aa91ccf8496fca))
* **cli:** catch `WorkerCancelled` in `await_prewarm_imports` ([#3178](https://github.com/diqiuzhuanzhuan/deepagents/issues/3178)) ([aa0d0f7](https://github.com/diqiuzhuanzhuan/deepagents/commit/aa0d0f732680a917bfc407f61f689326006be163))
* **cli:** dedupe MCP servers in project trust approval prompt ([#3342](https://github.com/diqiuzhuanzhuan/deepagents/issues/3342)) ([73484ea](https://github.com/diqiuzhuanzhuan/deepagents/commit/73484ea551189985190f52cb26b299819d3fc37d))
* **cli:** expand `${VAR}` in `mcp.json` header values ([#3523](https://github.com/diqiuzhuanzhuan/deepagents/issues/3523)) ([6cfc5f9](https://github.com/diqiuzhuanzhuan/deepagents/commit/6cfc5f9004271c23c486a0b05e8f9f0002e75e2b))
* **cli:** gate async task tools by actual names ([#3094](https://github.com/diqiuzhuanzhuan/deepagents/issues/3094)) ([aae8dfe](https://github.com/diqiuzhuanzhuan/deepagents/commit/aae8dfebab184586322129ec162e083ebfd372cc))
* **cli:** halt turn immediately when `ask_user` is cancelled ([#3258](https://github.com/diqiuzhuanzhuan/deepagents/issues/3258)) ([00d9b99](https://github.com/diqiuzhuanzhuan/deepagents/commit/00d9b99ce748d34cb150e08e2c46be6d648b3170))
* **cli:** hide approval menu on selection ([#3097](https://github.com/diqiuzhuanzhuan/deepagents/issues/3097)) ([7dafd30](https://github.com/diqiuzhuanzhuan/deepagents/commit/7dafd3049ad7725353bbf12bf80f476b52916208))
* **cli:** keep Thinking spinner during `edit_file` approval ([#3310](https://github.com/diqiuzhuanzhuan/deepagents/issues/3310)) ([d06133f](https://github.com/diqiuzhuanzhuan/deepagents/commit/d06133f8dd7cb924c82e46ece3e165d561ef7d9e))
* **cli:** move internal state under hidden directory ([#3106](https://github.com/diqiuzhuanzhuan/deepagents/issues/3106)) ([ef4c717](https://github.com/diqiuzhuanzhuan/deepagents/commit/ef4c71763086a4e4899ba7ced6f9eb478d38069e))
* **cli:** only restore iTerm2 cursor guide when it was enabled at startup ([#3256](https://github.com/diqiuzhuanzhuan/deepagents/issues/3256)) ([2620ff5](https://github.com/diqiuzhuanzhuan/deepagents/commit/2620ff56d1d89275e604e756abe54c1408414167))
* **cli:** pause input cursor blink when terminal loses OS focus ([#3246](https://github.com/diqiuzhuanzhuan/deepagents/issues/3246)) ([8582b83](https://github.com/diqiuzhuanzhuan/deepagents/commit/8582b8355d5c0c70f45cee9522e4c8e02264005e))
* **cli:** preserve recent agent across thread resume ([#3108](https://github.com/diqiuzhuanzhuan/deepagents/issues/3108)) ([442a0d4](https://github.com/diqiuzhuanzhuan/deepagents/commit/442a0d474aa1e767d542cb01f6e338431c18e5a8))
* **cli:** prevent import deadlock during skill discovery and prewarm ([#3385](https://github.com/diqiuzhuanzhuan/deepagents/issues/3385)) ([0bf8dd1](https://github.com/diqiuzhuanzhuan/deepagents/commit/0bf8dd1cfd680bd4d27ce19295f96c720f525787))
* **cli:** re-render assistant messages after streaming to fix fenced code disappearance ([#3293](https://github.com/diqiuzhuanzhuan/deepagents/issues/3293)) ([01b0a44](https://github.com/diqiuzhuanzhuan/deepagents/commit/01b0a44353a891a2ff10b3a2e2f6e23cc0879c9b))
* **cli:** remove legacy shell tool aliases and harden HITL widget cleanup ([#3340](https://github.com/diqiuzhuanzhuan/deepagents/issues/3340)) ([398f7f4](https://github.com/diqiuzhuanzhuan/deepagents/commit/398f7f4512182a8e51cbdfbfb9dc211c77014e2b))
* **cli:** scroll tall `ask_user prompts` to top of viewport ([#3238](https://github.com/diqiuzhuanzhuan/deepagents/issues/3238)) ([705daa7](https://github.com/diqiuzhuanzhuan/deepagents/commit/705daa7e651153cb2cf80455131fcfe4311973b9))
* **cli:** show `Resuming...` banner immediately on thread resume ([#3297](https://github.com/diqiuzhuanzhuan/deepagents/issues/3297)) ([3bb2782](https://github.com/diqiuzhuanzhuan/deepagents/commit/3bb2782ae8bd42d9521b611ebdfc42456b7d41a2))
* **cli:** show detached HEAD commit in local context ([#3144](https://github.com/diqiuzhuanzhuan/deepagents/issues/3144)) ([569d4f0](https://github.com/diqiuzhuanzhuan/deepagents/commit/569d4f0d7d699bace7820eb171a6bd605b2a1a18))
* **cli:** show pending token placeholder during streaming and restore on early exit ([#3288](https://github.com/diqiuzhuanzhuan/deepagents/issues/3288)) ([882232d](https://github.com/diqiuzhuanzhuan/deepagents/commit/882232dbc4ffbaf0bedeb12f0f3119024352ac43))
* **cli:** support `state` deploy backend ([#3790](https://github.com/diqiuzhuanzhuan/deepagents/issues/3790)) ([04b4bb9](https://github.com/diqiuzhuanzhuan/deepagents/commit/04b4bb946fc5ff914b8cccc8c9543d10533de0f8))
* **cli:** suppress LangSmith trace for `_context_tokens` state writes ([#3317](https://github.com/diqiuzhuanzhuan/deepagents/issues/3317)) ([63db13e](https://github.com/diqiuzhuanzhuan/deepagents/commit/63db13ee262d19a1a87fbe4df1271a2e958deed6))
* **cli:** suppress noisy network warnings from interrupt cleanup ([#3250](https://github.com/diqiuzhuanzhuan/deepagents/issues/3250)) ([4e4a8fe](https://github.com/diqiuzhuanzhuan/deepagents/commit/4e4a8fedd1ed72606ac0df336859ba5d7180021f))
* **cli:** suppress token placeholder on first invoke ([#3302](https://github.com/diqiuzhuanzhuan/deepagents/issues/3302)) ([c21dee2](https://github.com/diqiuzhuanzhuan/deepagents/commit/c21dee2e9bc1a7d3f52ff62e9e66d1caaaf7b464))
* **cli:** sync thread ID and render clickable link on `/clear` ([#3305](https://github.com/diqiuzhuanzhuan/deepagents/issues/3305)) ([0904974](https://github.com/diqiuzhuanzhuan/deepagents/commit/0904974d52dff259809d00a7a8b26c3e894cc0c0))
* **cli:** truncate multi-line shell commands in HITL approval ([#3314](https://github.com/diqiuzhuanzhuan/deepagents/issues/3314)) ([7ab6e14](https://github.com/diqiuzhuanzhuan/deepagents/commit/7ab6e14565d6dd9d9c9e76d9d6677e5568a727f7))
* **sdk:** default OpenRouter routing to ignore Azure upstream ([#3157](https://github.com/diqiuzhuanzhuan/deepagents/issues/3157)) ([01a9113](https://github.com/diqiuzhuanzhuan/deepagents/commit/01a911379d368fab8280cd827c38776800abe7b8))
...
* **cli:** gate dropped-path detection on multi-character insert size ([#3343](https://github.com/diqiuzhuanzhuan/deepagents/issues/3343)) ([06a21e8](https://github.com/diqiuzhuanzhuan/deepagents/commit/06a21e8a69738b7ba055d2f13dae4cd9fab353cd))
* **cli:** skip runtime imports for bare command help ([#3107](https://github.com/diqiuzhuanzhuan/deepagents/issues/3107)) ([9cc4f58](https://github.com/diqiuzhuanzhuan/deepagents/commit/9cc4f5837b8d705f3e5f604b6e6affa39876b2f5))
